...
namespace Code.FirstPersonPlayer
{
    ...
    public class PlayerMovement : MonoBehaviour
    {
        ...
        public void Move(float moveSpeed, float sprintSpeed, float speedChangeRate)
        {
            _speed = CalculateMovementSpeed(moveSpeed, sprintSpeed, speedChangeRate);
        ...
        private float CalculateMovementSpeed(float moveSpeed, float sprintSpeed, float speedChangeRate)
        {
            float speed;
            
            float targetSpeed = _input.ReadSprint() ? sprintSpeed : moveSpeed;
